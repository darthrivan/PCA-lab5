...
void init_sampler(int k, int maxsamples)
{
  if (values)
    free(values);
...
/* CHANGE */
/* Change to Pentium IV cache size of 1Mb, which is 256K ints */
#define ASIZE (1 << 18)
...
{
  return fcyc2_full(f, param1, param2, clear_cache, 6, 0.001, 400, 0);
}
